                ...
                <div key={index} className="max-w-xs overflow-hidden bg-slate-200 rounded-lg shadow-md dark:bg-gray-800">
                    <div className="p-6">
                        <a href={bookmark.url} tabIndex="0" role="link">
                            <img className="object-cover w-full h-56" src="https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" alt="avatar"></img>
