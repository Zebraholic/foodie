    ...
    return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 font-bold mb-10 text-gray-800 dark:text-white">
            {dogToys.map((dogToy, index) => (
                <div key={index} className="max-w-xs overflow-hidden border-solid border-2 border-gray-200 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <div className="p-6">
                        <a href={dogToy.linkToBuy} tabIndex="0" role="link">
                            <img className="object-cover w-200 mx-auto mb-5 h-56" src={dogToy.image.url} alt="avatar"></img>
